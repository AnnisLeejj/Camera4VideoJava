...
public class Camera2VideoFragment extends Fragment
    ...
    public static Camera2VideoFragment newInstance(String savePath, int maxLength) {
        Camera2VideoFragment videoFragment = new Camera2VideoFragment();
    ...
    private static Size chooseVideoSize(Size[] choices, int width, int height) {
        ...
        for (Size size : choices) {
            if (size.getWidth() <= 1080) {
                double ratio_source = getRatio(size.getWidth(), size.getHeight());
                if (Math.abs(ratio - ratio_source) < 0.1) {
                    return size;
                }
            }
        }
    ...
    private static double getRatio(int a, int b) {
        int w = Math.min(a, b);
        int h = Math.max(a, b);
        return (1.0 * w) / h;
    }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mButtonVideo = view.findViewById(R.id.btVideoControl);
...
//                mTextureView.setAspectRatio(1080,2560);
...
//            }
            ...
            mCameraDevice.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            // UI
                            mButtonVideo.setBackgroundResource(R.drawable.ic_stop);
    ...
    private void stopRecordingVideo() {
        ...
        mButtonVideo.setBackgroundResource(R.drawable.ic_start);
        // Stop recording
        mMediaRecorder.stop();
